...
[![Latest Version](https://img.shields.io/github/release/Cristake/l5-newsletter.svg?style=flat-square)](https://github.com/Cristake/l5-newsletter/releases)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
[![Build Status](https://img.shields.io/travis/Cristake/l5-newsletter/master.svg?style=flat-square)](https://travis-ci.org/Cristake/l5-newsletter)
...
[![Quality Score](https://img.shields.io/scrutinizer/g/Cristake/l5-newsletter.svg?style=flat-square)](https://scrutinizer-ci.com/g/Cristake/l5-newsletter)
[![Total Downloads](https://img.shields.io/packagist/dt/Cristake/l5-newsletter.svg?style=flat-square)](https://packagist.org/packages/Cristake/l5-newsletter)
...
Cristake is a webdesign agency in Antwerp, Belgium. You'll find an overview of all our open source projects [on our website](https://Cristake.be/opensource).
...
```bash
composer require Cristake/l5-newsletter
```
...
'providers' => [
    ...
    'Cristake\Newsletter\NewsletterServiceProvider',
    ...
];
```
...
'aliases' => [
    ...
    'Newsletter' => 'Cristake\Newsletter\NewsletterFacade',
];
```

To publish the config file to ``app/config/l5-newsletter.php`` run:

```bash
php artisan vendor:publish --provider="Cristake\Newsletter\NewsletterServiceProvider"
```

This wil publish a file `l5-newsletter.php` in your config directory with the following contents: 
```php
return [
...
If you discover any security related issues, please email [freek@Cristake.be](mailto:freek@Cristake.be) instead of using the issue tracker.
